...
*/
    ...
    function generateBarChart(element, barQty, height, animate, easing, duration, delay, color, tooltip) {
		...
		for (var i = 0; i < bardataJSON.length; i++) {
			bardata.push(bardataJSON[i].value)
		}
  ...
  //          bardata.push(Math.round(Math.random()*10) + 10)
    ...
    // Initialize charts
    progressCounter('#hours-available-progress', 38, 2, "#F06292", 0.67, "icon-watch text-pink-400", 'Hours available', '64% average')
